const Projects = {
    Details:{//adding in opposite-chronological order, so it's easy to add later    
        ...
        TheWasteland: {
            ...
            LargeDescription: "• This was my first year project of endless runner game with the shooting mechanics.<br> • Platforms are autogenerated with tweakable values of distance. <br> • Speed of the character increases as the time increases.<br> • Currency system and Shopping system for the characters.<br> • Saving system for the highscore as well as currency and saved characters.",
